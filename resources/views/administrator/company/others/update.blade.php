<div class="modal fade" id="modal-update-others">
    <form action="{{ route('company.content.updateInfo') }}" method="post" id="form-update-others" class="modal-dialog" data-asyn="no" enctype="multipart/form-data">
        @csrf
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <small>la imagen debe ser al menos 392x196px</small>
            </div>   
        </div>
