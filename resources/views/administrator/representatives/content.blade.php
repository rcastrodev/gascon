...
@section('content_header')
    <div class="d-flex">
        <h1 class="mr-3">Representadas</h1>
    </div>
@stop
@section('content')
    ...
    @isset($section1)
        <form action="{{ route('representative.update-info') }}" class="mb-5" method="post" enctype="multipart/form-data" data-asyn="no">
            @csrf
    ...
    <div class="row mb-5">
        <div class="col-sm-12">
            <div class="d-flex">
                <h3 class="mr-3">Representadas</h3>
...
@includeIf('administrator.representatives.modals.create')
@includeIf('administrator.representatives.modals.update')
@stop
@section('css')
    <meta name="_token" content="{{csrf_token()}}">
    <meta name="url" content="{{route('representative.content')}}">
...
@section('js')
    ...
    <script src="{{ asset('js/admin/representatives/index.js') }}"></script>
