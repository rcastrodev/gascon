<div class="modal fade" id="modal-create-others">
    <form action="{{ route('company.content.updateInfo') }}" method="post" class="modal-dialog" data-info="reset" data-asyn="no" enctype="multipart/form-data">
        @csrf
